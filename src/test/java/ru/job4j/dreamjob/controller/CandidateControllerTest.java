...
class CandidateControllerTest {
    ...
    @Test
    public void whenPostCandidateWithFileThenSameDataAndRedirectToCandidatePage() throws Exception {
        ...
        when(candidateService.save(candidateArgumentCaptor.capture(), fileDtoCaptor.capture())).thenReturn(candidate);
    ...
    @Test
    public void whenGetByIdThenReturnCandidatePage() {
        var candidate = new Candidate(1, "name", "desc", now(), 1, 2);
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
    ...
    @Test
    public void whenGetByIdNotFoundThenReturnErrorPage() {
    ...
    @Test
    public void whenUpdateCandidateSuccessfullyThenRedirect() {
        var candidate = new Candidate(1, "name", "desc", now(), 1, 2);
    ...
    @Test
    public void whenUpdateCandidateNotFoundThenErrorPage() {
        var candidate = new Candidate(1, "name", "desc", now(), 1, 2);
        var candidateException = new RuntimeException("Кандидат с указанным идентификатором не найден");
        ...
        assertThat(view).isEqualTo("errors/404");
        assertThat(actualExceptionMessage).isEqualTo(candidateException.getMessage());
    }

    @Test
    public void whenDeleteCandidateSuccessfullyThenRedirect() {
    ...
    @Test
    public void whenDeleteCandidateNotFoundThenErrorPage() {
        var expectedException = new RuntimeException("Кандидат с указанным идентификатором не найден");
