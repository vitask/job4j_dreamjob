...
class VacancyControllerTest {
    ...
    public void whenPostVacancyWithFileThenSameDataAndRedirectToVacanciesPage() throws Exception {
        ...
        when(vacancyService.save(vacancyArgumentCaptor.capture(), fileDtoCaptor.capture())).thenReturn(vacancy);
    ...
    @Test
    public void whenGetByIdThenReturnVacancyPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
    ...
    @Test
    public void whenUpdateVacancySuccessfullyThenRedirect() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenUpdateVacancyNotFoundThenErrorPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var vacancyException = new RuntimeException("Вакансия с указанным идентификатором не найдена");
        ...
        assertThat(view).isEqualTo("errors/404");
        assertThat(actualExceptionMessage).isEqualTo(vacancyException.getMessage());
    }

    @Test
    public void whenDeleteVacancySuccessfullyThenRedirect() {
    ...
    @Test
    public void whenDeleteVacancyNotFoundThenErrorPage() {
